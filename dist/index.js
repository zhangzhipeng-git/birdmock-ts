...
var CONFIG_FILE_TEMPLATE_PATH = './example/config.js';
var MOCKS_DIR = 'mocks';
var MOCKS_FILE_TEMPLATE = 'response.js';
var MOCKS_FILE_TEMPLATE_PATH = './example/response.js';
var LOGS_DIR = 'logs';
...
var ServerBoot = (function () {
    ...
    ServerBoot.getPaths = function () {
        ...
        if (!fs_1.default.existsSync(configPath) || !fs_1.default.statSync(configPath).isFile()) {
            var cfg = require(CONFIG_FILE_TEMPLATE_PATH);
            fs_1.default.writeFileSync(configPath, JSON.stringify(cfg, null, '\t'));
        }
        ...
        if (!fs_1.default.existsSync(mocksPath) || !fs_1.default.statSync(mocksPath).isDirectory()) {
            ...
            var exampleFilePath = path_1.default.resolve(mocksPath, MOCKS_FILE_TEMPLATE);
            var exampleFileContent = require(MOCKS_FILE_TEMPLATE_PATH);
            fs_1.default.writeFileSync(exampleFilePath, exampleFileContent);
        }
